// Plain-JS port of the CIDR matching in src/lib/ip.ts, for use by server.js
// which runs as a bare Node script outside the Next.js/TypeScript build (so
// it can't import a .ts module directly). Keep the two in sync if either
// changes.
...
function expandIpv6Groups(parts) {
...
function isIpAllowlisted(ip, list) {
...
module.exports = { normalizeIp, isIpInCidr, isIpAllowlisted };
